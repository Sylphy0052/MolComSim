...
public class InformationMolecule extends Molecule{
	...
	public InformationMolecule(Position psn, int numSeq, MolComSim sim, NanoMachine src, int msgNum, MoleculeMovementType molMvType) {
	...
	public InformationMolecule(Position psn, int numSeq, MolComSim sim, NanoMachine src, int msgNum, MoleculeMovementType molMvType, double volume) {
